                ...
                <div>
                  ...
                  {data?.book_authors?.web ? (
                    <a
                      ...
                      className='mt-1 flex w-16 items-center rounded text-[15px] font-medium text-emerald-500 transition-all duration-200 hover:text-emerald-600 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-emerald-500'
                      target='_blank'
                      rel='noreferrer'
                    >
                      Web
